function [ FieldThreshold ] = QueryThresholdTableVfield3389( Amplitude, PulseWidth, AxonDiameter, NumberOfRings)
...
load('LookUpTableMonopolar.mat');
InputArgumentsLookUpTable = XML2struct('InputArgumentsLookUpTableConventionalLeads.xml');
...
[X,Y,Z,C] = ndgrid(AmplitudeList, PulseWidthList,...
    AxonDiameterList, NumberOfRingsList);
...
%  SteeringAmount
FieldThreshold = interpn(X,Y,Z,C, LookUpTable,...
    Amplitude, PulseWidth, AxonDiameter, NumberOfRings)
