function [x, y, z, ScaledFieldDataV, IsolevelV]=get3389vtavolume(Amplitude, contactnr)
...
% Generate filenames
FileName = ['ExportedGridDataContact',num2str(contactnr),'.bin'];
...
handles.NumberOfActiveRings = 1;
SteeringAmount = 1;
% direction = Degrees; % degrees clockwise

IsolevelV = QueryThresholdTableVfield3389(...
       MaximumVoltage(1), handles.PulseWidth, handles.AxonDiameter, handles.NumberOfActiveRings);
% IsolevelV = 0.5;                
